	...
	<div class="row">
		<div class="col-md-12">
			<div class="card border-0">
				...
				<form action="<?php echo route('question/addQuestion&cat_id='.$_GET['cat_id']); ?>" method="POST">
				<div class="card-body">
					<div class="row mb-3">
						<div class="col-md-12">
							<h3>คำถาม</h3>
							<textarea name="question_title" id="" cols="30" rows="5" class="form-control"></textarea>
						</div>
					</div>
					<div class="row mb-3">
						<div class="col-md-12">
